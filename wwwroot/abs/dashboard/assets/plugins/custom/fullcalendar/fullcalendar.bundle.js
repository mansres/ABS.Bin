...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ _proto_: [] } instanceof Array && function (d, b) { d._proto_ = b; }) ||
    ...
    var _assign = function() {
        _assign = Object.assign || function _assign(t) {
    ...
    function createFormatter(input, defaultSeparator) {
        if (typeof input === 'object' && input) { // non-null object
            if (typeof defaultSeparator === 'string') {
                input = _assign({ separator: defaultSeparator }, input);
            }
    ...
    */
    ...
    function applyMutationToEventDef(eventDef, eventConfig, mutation, appliers, calendar) {
        ...
        var copy = _assign({}, eventDef, standardProps, { ui: _assign({}, eventDef.ui, standardProps.ui) });
    ...
    function isNewPropsValid(newProps, calendar) {
        ...
        var props = _assign({ businessHours: view ? view.props.businessHours : createEmptyEventStore(), dateSelection: '', eventStore: calendar.state.eventStore, eventUiBases: calendar.eventUiBases, eventSelection: '', eventDrag: null, eventResize: null }, newProps);
    ...
    function isInteractionPropsValid(state, calendar, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            for (var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++) {
                ...
                var subjectDateSpan = _assign({}, dateSpanMeta, { range: subjectInstance.range, allDay: subjectDef.allDay });
    ...
    */
    ...
    var ElementScrollController = /** @class */ (function (_super) {
        _extends(ElementScrollController, _super);
    ...
    var WindowScrollController = /** @class */ (function (_super) {
        _extends(WindowScrollController, _super);
    ...
    */
    var ScrollComponent = /** @class */ (function (_super) {
        _extends(ScrollComponent, _super);
    ...
    */
    ...
    function fetchSource(eventSource, fetchRange, calendar) {
        ...
        return _assign({}, eventSource, { isFetching: true, latestFetchId: fetchId });
    }
    function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
        ...
        if (eventSource && // not already removed
            ...
            return _assign({}, sourceHash, (_a = {}, _a[sourceId] = _assign({}, eventSource, { isFetching: false, fetchRange: fetchRange }), _a));
        }
        return sourceHash;
    }
    ...
    function reduce (state, action, calendar) {
        ...
        var nextState = _assign({}, state, { viewType: viewType,
    ...
    */
    ...
    var CalendarComponent = /** @class */ (function (_super) {
        _extends(CalendarComponent, _super);
        ...
        CalendarComponent.prototype.renderToolbars = function (viewSpec, dateProfile, currentDate, dateProfileGenerator, title) {
            ...
            if (headerLayout) {
                ...
                this.header.receiveProps(_assign({ layout: headerLayout }, toolbarProps));
            }
            else if (this.header) {
                this.header.destroy();
                this.header = null;
            ...
            if (footerLayout) {
                ...
                this.footer.receiveProps(_assign({ layout: footerLayout }, toolbarProps));
            }
            else if (this.footer) {
                this.footer.destroy();
                this.footer = null;
    ...
    */
    ...
    var Calendar = /** @class */ (function () {
        ...
        */
        Calendar.prototype.renderComponent = function (needsFull) {
            ...
            component.receiveProps(_assign({}, state, { viewSpec: viewSpec, dateProfile: state.dateProfile, dateProfileGenerator: this.dateProfileGenerators[viewType], eventStore: renderableEventStore, eventUiBases: eventUiBases, dateSelection: state.dateSelection, eventSelection: state.eventSelection, eventDrag: state.eventDrag, eventResize: state.eventResize }));
            if (savedScroll) {
        ...
        */
        ...
        Calendar.prototype._buildEventUiSingleBase = function (rawOpts) {
            if (rawOpts.editable) { // so 'editable' affected events
                rawOpts = _assign({}, rawOpts, { eventEditable: true });
            }
        ...
        Calendar.prototype.triggerDateSelect = function (selection, pev) {
            var arg = _assign({}, this.buildDateSpanApi(selection), { jsEvent: pev ? pev.origEvent : null, view: this.view });
        ...
        Calendar.prototype.triggerDateClick = function (dateSpan, dayEl, view, ev) {
            var arg = _assign({}, this.buildDatePointApi(dateSpan), { dayEl: dayEl, jsEvent: ev, // Is this always a mouse event? See #4655
                view: view });
    ...
    function buildSegCompareObj(seg) {
        ...
        return _assign({}, eventDef.extendedProps, eventDef, { id: eventDef.publicId, start: start,
    ...
    */
    ...
    function buildDateEnv$1(settings) {
        ...
        settings = _assign({ timeZone: globalDefaults.timeZone, calendarSystem: 'gregory' }, settings, { locale: locale });
...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DayGridDateProfileGenerator = /** @class */ (function (_super) {
        _extends(DayGridDateProfileGenerator, _super);
    ...
    */
    ...
    var SimpleDayGridEventRenderer = /** @class */ (function (_super) {
        _extends(SimpleDayGridEventRenderer, _super);
    ...
    var DayGridEventRenderer = /** @class */ (function (_super) {
        _extends(DayGridEventRenderer, _super);
    ...
    var DayGridMirrorRenderer = /** @class */ (function (_super) {
        _extends(DayGridMirrorRenderer, _super);
    ...
    var DayGridFillRenderer = /** @class */ (function (_super) {
        _extends(DayGridFillRenderer, _super);
    ...
    var DayTileEventRenderer = /** @class */ (function (_super) {
        _extends(DayTileEventRenderer, _super);
    ...
    var DayGrid = /** @class */ (function (_super) {
        ...
        DayGrid.prototype.resliceDaySegs = function (segs, dayDate) {
            ...
            for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                ...
                if (slicedRange) {
                    newSegs.push(_assign({}, seg, { eventRange: {
                            def: eventRange.def,
                            ui: _assign({}, eventRange.ui, { durationEditable: false }),
    ...
    var SimpleDayGrid = /** @class */ (function (_super) {
        ...
        SimpleDayGrid.prototype.render = function (props) {
            ...
            dayGrid.receiveProps(_assign({}, this.slicer.sliceProps(props, dateProfile, props.nextDayThreshold, dayGrid, dayTable), { dateProfile: dateProfile, cells: dayTable.cells, isRigid: props.isRigid }));
        };
...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function buildRequestParams(range, apiKey, extraParams, dateEnv) {
        ...
        params = _assign({}, (extraParams || {}), { key: apiKey, timeMin: startStr, timeMax: endStr, singleEvents: true, maxResults: 9999 });
        if (dateEnv.timeZone !== 'local') {
...
(function (global, factory) {
    ...
    */
    var ScrollGeomCache = /** @class */ (function (_super) {
        _extends(ScrollGeomCache, _super);
    ...
    var ElementScrollGeomCache = /** @class */ (function (_super) {
        _extends(ElementScrollGeomCache, _super);
    ...
    var WindowScrollGeomCache = /** @class */ (function (_super) {
        _extends(WindowScrollGeomCache, _super);
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        _extends(FeaturefulElementDragging, _super);
                ...
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var eventDropArg = _assign({}, transformed, { el: ev.subjectEl, delta: validMutation.datesDelta, oldEvent: eventApi, event: new core.EventApi(// the data AFTER the mutation
                            ...
                            var dropArg = _assign({}, receivingCalendar.buildDatePointApi(finalHit.dateSpan), { draggedEl: ev.subjectEl, jsEvent: ev.origEvent, view: finalHit.component // should this be finalHit.component.view? See #4644
                             });
        ...
        function ExternalElementDragging(dragging, suppliedDragMeta) {
            ...
            this.handleDragEnd = function (pev) {
                ...
                if (receivingCalendar && droppableEvent) {
                    ...
                    var arg = _assign({}, receivingCalendar.buildDatePointApi(finalHit.dateSpan), { draggedEl: pev.subjectEl, jsEvent: pev.origEvent, view: finalView });
    ...
    */
    var InferredElementDragging = /** @class */ (function (_super) {
        _extends(InferredElementDragging, _super);
...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ListEventRenderer = /** @class */ (function (_super) {
        _extends(ListEventRenderer, _super);
...
(function (global, factory) {
    ...
    */
    var TimeGridEventRenderer = /** @class */ (function (_super) {
        _extends(TimeGridEventRenderer, _super);
    ...
    var TimeGridMirrorRenderer = /** @class */ (function (_super) {
        _extends(TimeGridMirrorRenderer, _super);
    ...
    var TimeGridFillRenderer = /** @class */ (function (_super) {
        _extends(TimeGridFillRenderer, _super);
    ...
    var AllDaySplitter = /** @class */ (function (_super) {
        _extends(AllDaySplitter, _super);
    ...
    var SimpleTimeGrid = /** @class */ (function (_super) {
        _extends(SimpleTimeGrid, _super);
        ...
        SimpleTimeGrid.prototype.render = function (props) {
            ...
            this.timeGrid.receiveProps(_assign({}, this.slicer.sliceProps(props, dateProfile, null, this.timeGrid, dayRanges), { dateProfile: dateProfile, cells: dayTable.cells[0] }));
        };
    ...
    var TimeGridSlicer = /** @class */ (function (_super) {
        _extends(TimeGridSlicer, _super);
    ...
    var TimeGridView$1 = /** @class */ (function (_super) {
        ...
        TimeGridView.prototype.render = function (props) {
            ...
            this.simpleTimeGrid.receiveProps(_assign({}, splitProps['timed'], { dateProfile: dateProfile,
                dayTable: dayTable }));
            if (this.simpleDayGrid) {
                this.simpleDayGrid.receiveProps(_assign({}, splitProps['allDay'], { dateProfile: dateProfile,
