...
var StudioApp = function() {
    ...
    var initPortlet = function(el, options) {
        // init portlet tools
        var el = $(el);
        var portlet = new StudioPortlet(el[0], options);
    }
    ...
    var Plugin = {
        ...
        build: function() {
            ...
            if (Plugin.getSubmenuMode() === 'dropdown' || Plugin.isConditionalSubmenuDropdown()) {
                ...
                the.eventHandlers['event_2'] = StudioUtil.on( element, '[data-ktmenu-submenu-toggle="hover"]', 'mouseover', Plugin.handleSubmenuDrodownHoverEnter);
                the.eventHandlers['event_3'] = StudioUtil.on( element, '[data-ktmenu-submenu-toggle="hover"]', 'mouseout', Plugin.handleSubmenuDrodownHoverExit);

                // dropdown submenu - click toggle
                the.eventHandlers['event_4'] = StudioUtil.on( element, '[data-ktmenu-submenu-toggle="click"] > .abs-menu_toggle, [data-ktmenu-submenu-toggle="click"] > .abs-menu_link .abs-menu_toggle', 'click', Plugin.handleSubmenuDropdownClick);
                the.eventHandlers['event_5'] = StudioUtil.on( element, '[data-ktmenu-submenu-toggle="tab"] > .abs-menu_toggle, [data-ktmenu-submenu-toggle="tab"] > .abs-menu_link .abs-menu_toggle', 'click', Plugin.handleSubmenuDropdownTabClick);
            }
        ...
        */
        ...
        getSubmenuMode: function(el) {
            if ( StudioUtil.isInResponsiveRange('desktop') ) {
                if (el && StudioUtil.hasAttr(el, 'data-ktmenu-submenu-toggle') && StudioUtil.attr(el, 'data-ktmenu-submenu-toggle') == 'hover') {
                    return 'dropdown';
                }
        ...
        scrollToItem: function(item) {
            ...
            if ( StudioUtil.isInResponsiveRange('desktop') && the.options.accordion.autoScroll && element.getAttribute('data-ktmenu-scroll') !== '1' ) {
        ...
        hideSubmenuDropdown: function(item, classAlso) {
            ...
            if ( item.getAttribute('data-ktmenu-dropdown-toggle-class') ) {
                StudioUtil.removeClass(body, item.getAttribute('data-ktmenu-dropdown-toggle-class'));
            }
        ...
        hideSubmenuDropdowns: function() {
            var items;
            if ( items = element.querySelectorAll('.abs-menu_item--submenu.abs-menu_item--hover:not(.abs-menu_item--tabs):not([data-ktmenu-submenu-toggle="tab"])') ) {
        ...
        showSubmenuDropdown: function(item) {
            ...
            if ( item.getAttribute('data-ktmenu-dropdown-toggle-class') ) {
                StudioUtil.addClass(body, item.getAttribute('data-ktmenu-dropdown-toggle-class'));
            }
        },
...
document.addEventListener("click", function (e) {
    var body = StudioUtil.get('body');
    var query;
    if ( query = body.querySelectorAll('.abs-menu_nav .abs-menu_item.abs-menu_item--submenu.abs-menu_item--hover:not(.abs-menu_item--tabs)[data-ktmenu-submenu-toggle="hover"]') ) {
...
"use strict";
// plugin setup
var StudioPortlet = function(elementId, options) {
    // Main object
    var the = this;
    var init = false;
    ...
    var Plugin = {
        ...
        construct: function(options) {
            if (StudioUtil.data(element).has('portlet')) {
                the = StudioUtil.data(element).get('portlet');
            } else {
                // reset menu
                Plugin.init(options);
                ...
                StudioUtil.data(element).set('portlet', the);
            }
        ...
        init: function(options) {
            ...
            // merge default and user defined options
            the.options = StudioUtil.deepExtend({}, defaultOptions, options);
            the.head = StudioUtil.child(element, '.abs-portlet_head');
            the.foot = StudioUtil.child(element, '.abs-portlet_foot');

            if (StudioUtil.child(element, '.abs-portlet_body')) {
                the.body = StudioUtil.child(element, '.abs-portlet_body');
        ...
        build: function() {
            // Remove
            var remove = StudioUtil.find(the.head, '[data-ktportlet-tool=remove]');
            if (remove) {
            ...
            // Reload
            var reload = StudioUtil.find(the.head, '[data-ktportlet-tool=reload]');
            if (reload) {
            ...
            // Toggle
            var toggle = StudioUtil.find(the.head, '[data-ktportlet-tool=toggle]');
            if (toggle) {
            ...
            //== Fullscreen
            var fullscreen = StudioUtil.find(the.head, '[data-ktportlet-tool=fullscreen]');
            if (fullscreen) {
        ...
        onScrollSticky: function(e) {
            ...
            if (st >= offset && StudioUtil.hasClass(body, 'abs-portlet--sticky') === false) {
                Plugin.eventTrigger('stickyOn');

                StudioUtil.addClass(body, 'abs-portlet--sticky');
                StudioUtil.addClass(element, 'abs-portlet--sticky');

                Plugin.updateSticky();

            } else if ((st*1.5) <= offset && StudioUtil.hasClass(body, 'abs-portlet--sticky')) {
                // back scroll mode
                Plugin.eventTrigger('stickyOff');

                StudioUtil.removeClass(body, 'abs-portlet--sticky');
                StudioUtil.removeClass(element, 'abs-portlet--sticky');
        ...
        updateSticky: function() {
            ...
            if (StudioUtil.hasClass(body, 'abs-portlet--sticky')) {
        ...
        resetSticky: function() {
            ...
            if (StudioUtil.hasClass(body, 'abs-portlet--sticky') === false) {
        ...
        remove: function() {
            ...
            if (StudioUtil.hasClass(body, 'abs-portlet--fullscreen') && StudioUtil.hasClass(element, 'abs-portlet--fullscreen')) {
        ...
        setupTooltips: function() {
            if (the.options.tooltips) {
                var collapsed = StudioUtil.hasClass(element, 'abs-portlet--collapse') || StudioUtil.hasClass(element, 'abs-portlet--collapsed');
                var fullscreenOn = StudioUtil.hasClass(body, 'abs-portlet--fullscreen') && StudioUtil.hasClass(element, 'abs-portlet--fullscreen');
         ...
         */
        toggle: function() {
            if (StudioUtil.hasClass(element, 'abs-portlet--collapse') || StudioUtil.hasClass(element, 'abs-portlet--collapsed')) {
                Plugin.expand();
            } else {
                Plugin.collapse();
            }
        ...
        collapse: function() {
            ...
            StudioUtil.addClass(element, 'abs-portlet--collapse');
        ...
        expand: function() {
            ...
            StudioUtil.removeClass(element, 'abs-portlet--collapse');
            StudioUtil.removeClass(element, 'abs-portlet--collapsed');
        ...
        fullscreen: function(mode) {
            ...
            if (mode === 'off' || (StudioUtil.hasClass(body, 'abs-portlet--fullscreen') && StudioUtil.hasClass(element, 'abs-portlet--fullscreen'))) {
                Plugin.eventTrigger('beforeFullscreenOff');

                StudioUtil.removeClass(body, 'abs-portlet--fullscreen');
                StudioUtil.removeClass(element, 'abs-portlet--fullscreen');
                ...
                StudioUtil.addClass(element, 'abs-portlet--fullscreen');
                StudioUtil.addClass(body, 'abs-portlet--fullscreen');
...
// Class definition
var StudioChat = function () {
    var initChat = function (parentEl) {
        var messageListEl = StudioUtil.find(parentEl, '.abs-scroll');
        ...
        StudioUtil.scrollInit(messageListEl, {
            ...
            height: function() {  // calculate height
                ...
                // Mobile mode
                if (StudioUtil.isInResponsiveRange('tablet-and-mobile')) {
                    return StudioUtil.hasAttr(messageListEl, 'data-mobile-height') ? parseInt(StudioUtil.attr(messageListEl, 'data-mobile-height')) : 300;
                }

                // Desktop mode
                if (StudioUtil.isInResponsiveRange('desktop') && StudioUtil.hasAttr(messageListEl, 'data-height')) {
                    return parseInt(StudioUtil.attr(messageListEl, 'data-height'));
                }

                var chatEl = StudioUtil.find(parentEl, '.abs-chat');
                var portletHeadEl = StudioUtil.find(parentEl, '.abs-portlet > .abs-portlet_head');
                var portletBodyEl = StudioUtil.find(parentEl, '.abs-portlet > .abs-portlet_body');
                var portletFootEl = StudioUtil.find(parentEl, '.abs-portlet > .abs-portlet_foot');
                ...
                if (chatEl) {
                    height = height - parseInt(StudioUtil.css(chatEl, 'margin-top')) - parseInt(StudioUtil.css(chatEl, 'margin-bottom'));
                    height = height - parseInt(StudioUtil.css(chatEl, 'padding-top')) - parseInt(StudioUtil.css(chatEl, 'padding-bottom'));
                }

                if (portletHeadEl) {
                    height = height - parseInt(StudioUtil.css(portletHeadEl, 'height'));
                    height = height - parseInt(StudioUtil.css(portletHeadEl, 'margin-top')) - parseInt(StudioUtil.css(portletHeadEl, 'margin-bottom'));
                }

                if (portletBodyEl) {
                    height = height - parseInt(StudioUtil.css(portletBodyEl, 'margin-top')) - parseInt(StudioUtil.css(portletBodyEl, 'margin-bottom'));
                    height = height - parseInt(StudioUtil.css(portletBodyEl, 'padding-top')) - parseInt(StudioUtil.css(portletBodyEl, 'padding-bottom'));
                }

                if (portletFootEl) {
                    height = height - parseInt(StudioUtil.css(portletFootEl, 'height'));
                    height = height - parseInt(StudioUtil.css(portletFootEl, 'margin-top')) - parseInt(StudioUtil.css(portletFootEl, 'margin-bottom'));
                }
        ...
        var handleMessaging = function() {
            var scrollEl = StudioUtil.find(parentEl, '.abs-scroll');
            var messagesEl = StudioUtil.find(parentEl, '.abs-chat_messages');
            var textarea = StudioUtil.find(parentEl, '.abs-chat_input textarea');
            ...
            StudioUtil.addClass(node, 'abs-chat_message abs-chat_message--brand abs-chat_message--right');

            var html =
                '<div class="abs-chat_user">' +
                    '<span class="abs-chat_datetime">Just now</span>' +
                    '<a href="#" class="abs-chat_username">Jason Muller</span></a>' +
                    '<span class="abs-media abs-media--circle abs-media--sm">' +
                        '<img src="./assets/media/users/100_12.jpg" alt="image">'  +
                    '</span>' +
                '</div>' +
                '<div class="abs-chat_text abs-bg-light-brand">' +
                    textarea.value
                '</div>';

            StudioUtil.setHTML(node, html);
            messagesEl.appendChild(node);
            textarea.value = '';
            scrollEl.scrollTop = parseInt(StudioUtil.css(messagesEl, 'height'));

            var ps;
            if (ps = StudioUtil.data(scrollEl).get('ps')) {
                ps.update();
            }

            setTimeout(function() {
                var node = document.createElement("DIV");
                StudioUtil.addClass(node, 'abs-chat_message abs-chat_message--success');
                ...
                var html =
                    '<div class="abs-chat_user">' +
                        ...
                        '</span>' +
                        '<a href="#" class="abs-chat_username">Max Born</span></a>' +
                        '<span class="abs-chat_datetime">Just now</span>' +
                    '</div>' +
                    '<div class="abs-chat_text abs-bg-light-success">' +
        ...
        // attach events
        StudioUtil.on(parentEl, '.abs-chat_input textarea', 'keydown', function(e) {
            if (e.keyCode == 13) {
                handleMessaging();
                e.preventDefault();
        ...
        StudioUtil.on(parentEl, '.abs-chat_input .abs-chat_reply', 'click', function(e) {
            handleMessaging();
        });
    }
    ...
    return {
        ...
        init: function() {
            ...
            initChat( StudioUtil.getByID('abs_chat_modal'));
            ...
            if (encodeURI(window.location.hostname) == 'fenix-alliance.com' || encodeURI(window.location.hostname) == 'www.fenix-alliance.com') {
                setTimeout(function() {
                    if (!Cookies.get('abs_app_chat_shown')) {
                        var expires = new Date(new Date().getTime() + 60 * 60 * 1000); // expire in 60 minutes from now
                        Cookies.set('abs_app_chat_shown', 1, { expires: expires });
                        StudioUtil.getByID('abs_app_chat_launch_btn').click();
                    }
                }, 2000);
            }
        },
...
var StudioLayout = function() {
    ...
    var initAsideMenu = function() {
        ...
        var menuDesktopMode = (StudioUtil.attr(menu, 'data-ktmenu-dropdown') === '1' ? 'dropdown' : 'accordion');
    ...
    var initAsideToggler = function() {
        ...
        asideToggler.on('toggle', function(toggle) {
            ...
            if (StudioUtil.get('abs_page_portlet')) {
    ...
    var initPageStickyPortlet = function() {
        ...
        return new StudioPortlet('abs_page_portlet', {
            sticky: {
                ...
                position: {
                    ...
                    right: function(portlet) {
                        ...
                        var portletWidth = parseInt(StudioUtil.css(porletEl, 'width'));
                        var bodyWidth = parseInt(StudioUtil.css(StudioUtil.get('body'), 'width'));
                        var portletOffsetLeft = StudioUtil.offset(porletEl).left;
