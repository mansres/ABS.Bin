...
// Class definition
var StudioLayoutBuilder = function() {

	var exporter = {
		init: function() {
			$('#abs-btn-howto').click(function(e) {
				e.preventDefault();
				$('#abs-howto').slideToggle();
			});
		},
		startLoad: function(options) {
			$('#builder_export').
			addClass('abs-spinner abs-spinner--right abs-spinner--sm abs-spinner--light').
			find('span').text('Exporting...').
			closest('.abs-form_actions').
			find('.btn').
			attr('disabled', true);
		...
		doneLoad: function() {
			$('#builder_export').
			removeClass('abs-spinner abs-spinner--right abs-spinner--sm abs-spinner--light').
	...
	var verify = {
		reCaptchaVerified: function() {
			return $.ajax('../tools/builder/recaptcha.php?recaptcha', {
				...
				grecaptcha.reset();
				$('#alert-message').
				removeClass('alert-success abs-hide').
		...
		init: function() {
			...
			$('#builder_export').click(function(e) {
				...
				$('#abs-modal-purchase').modal('show');
				$('#alert-message').addClass('abs-hide');
				grecaptcha.reset();
			});
