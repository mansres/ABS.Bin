...
var StudioPortletTools = (function () {
  // Toastr
  ...
  var demo1 = function () {
    ...
    var portlet = new StudioPortlet("kt_portlet_tools_1");
    ...
    portlet.on("reload", function (portlet) {
      ...
      StudioApp.block(portlet.getSelf(), {
        overlayColor: "#ffffff",
        type: "loader",
        state: "success",
        opacity: 0.3,
      ...
      setTimeout(function () {
        StudioApp.unblock(portlet.getSelf());
      }, 2000);
    });
    ...
    portlet.on("afterFullscreenOn", function (portlet) {
      ...
      var scrollable = $(portlet.getBody()).find("> .abs-scroll");

      if (scrollable) {
        scrollable.data("original-height", scrollable.css("height"));
        scrollable.css("height", "100%");

        StudioUtil.scrollUpdate(scrollable[0]);
      }
    });
  ...
  var demo2 = function () {
    // This portlet is lazy initialized using data-portlet="true" attribute. You can access to the portlet object as shown below and override its behavior
    var portlet = new StudioPortlet("kt_portlet_tools_2");
  ...
  var demo3 = function () {
    // This portlet is lazy initialized using data-portlet="true" attribute. You can access to the portlet object as shown below and override its behavior
    var portlet = new StudioPortlet("kt_portlet_tools_3");
  ...
  var demo4 = function () {
    // This portlet is lazy initialized using data-portlet="true" attribute. You can access to the portlet object as shown below and override its behavior
    var portlet = new StudioPortlet("kt_portlet_tools_4");
  ...
  var demo5 = function () {
    // This portlet is lazy initialized using data-portlet="true" attribute. You can access to the portlet object as shown below and override its behavior
    var portlet = new StudioPortlet("kt_portlet_tools_5");
  ...
  var demo6 = function () {
    // This portlet is lazy initialized using data-portlet="true" attribute. You can access to the portlet object as shown below and override its behavior
    var portlet = new StudioPortlet("kt_portlet_tools_6");
