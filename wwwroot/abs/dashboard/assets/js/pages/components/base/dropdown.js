...
var StudioDropdownDemo = (function () {
  // Private functions

  // basic demo
  var demo1 = function () {
    var output = $("#kt_dropdown_api_output");
    var dropdown1 = new StudioDropdown("kt_dropdown_api_1");
    var dropdown2 = new StudioDropdown("kt_dropdown_api_2");
