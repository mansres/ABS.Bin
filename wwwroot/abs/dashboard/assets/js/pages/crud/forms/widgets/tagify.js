...
var StudioTagify = (function () {
  ...
  var demo3 = function () {
    ...
    //tagify.DOM.input.classList.remove('tagify_input');
    tagify.DOM.input.classList.add("form-control");
    tagify.DOM.input.setAttribute("placeholder", "enter tag...");

    // re-place Tagify's input element outside of the  element (tagify.DOM.scope), just before it
    tagify.DOM.scope.parentNode.insertBefore(
      tagify.DOM.input,
      tagify.DOM.scope
    );
  };
  ...
  var demo4 = function () {
    ...
    function transformTag(tagData) {
      ...
      tagData.class =
        "tagify_tag tagify_tag--" + states[StudioUtil.getRandomInt(0, 7)];
    ...
    var tagifyTo = new Tagify(toEl, {
      ...
      templates: {
        dropdownItem: function (tagData) {
          try {
            return (
              '<div class="tagify_dropdown_item">' +
