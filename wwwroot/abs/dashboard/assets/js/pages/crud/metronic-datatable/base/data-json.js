...
var StudioDatatableJsonRemoteDemo = (function () {
  // Private functions
  ...
  var demo = function () {
    var datatable = $(".abs-datatable").StudioDatatable({
      ...
      data: {
        type: "remote",
        source:
          "https://fenix-alliance.com/abss/preview/api/datatables/datasource/default.json",
        pageSize: 10,
      },
...
jQuery(document).ready(function () {
  StudioDatatableJsonRemoteDemo.init();
});
