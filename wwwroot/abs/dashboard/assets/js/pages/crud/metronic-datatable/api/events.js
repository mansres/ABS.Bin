...
var StudioDefaultDatatableDemo = (function () {
  ...
  var eventsCapture = function () {
    $(".abs-datatable")
      .on("abs-datatable--on-init", function () {
        eventsWriter("Datatable init");
      })
      .on("abs-datatable--on-layout-updated", function () {
        eventsWriter("Layout render updated");
      })
      .on("abs-datatable--on-ajax-done", function () {
        eventsWriter("Ajax data successfully updated");
      })
      .on("abs-datatable--on-ajax-fail", function (e, jqXHR) {
        eventsWriter("Ajax error");
      })
      .on("abs-datatable--on-goto-page", function (e, args) {
        eventsWriter("Goto to pagination: " + args.page);
      })
      .on("abs-datatable--on-update-perpage", function (e, args) {
        eventsWriter("Update page size: " + args.perpage);
      })
      .on("abs-datatable--on-reloaded", function (e) {
        eventsWriter("Datatable reloaded");
      })
      .on("abs-datatable--on-check", function (e, args) {
        eventsWriter("Checkbox active: " + args.toString());
      })
      .on("abs-datatable--on-uncheck", function (e, args) {
        eventsWriter("Checkbox inactive: " + args.toString());
      })
      .on("abs-datatable--on-sort", function (e, args) {
