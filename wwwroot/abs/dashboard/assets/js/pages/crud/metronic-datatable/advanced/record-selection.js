...
var StudioDatatableRecordSelectionDemo = (function () {
  // Private functions
  ...
  var localSelectorDemo = function () {
    ...
    var datatable = $("#local_record_selection").StudioDatatable(options);
    ...
    datatable.on(
      ...
      function (e) {
        var checkedNodes = datatable.rows(".abs-datatable_row--active").nodes();
    ...
    $("#kt_modal_fetch_id")
      .on("show.bs.modal", function (e) {
        ...
        $(e.target).find(".abs-datatable_selected_ids").append(c);
      })
      .on("hide.bs.modal", function (e) {
        $(e.target).find(".abs-datatable_selected_ids").empty();
      });
  };
  ...
  var serverSelectorDemo = function () {
    ...
    var datatable = $("#server_record_selection").StudioDatatable(options);
    ...
    datatable.on(
      "abs-datatable--on-click-checkbox abs-datatable--on-layout-updated",
      function (e) {
...
jQuery(document).ready(function () {
  StudioDatatableRecordSelectionDemo.init();
});
