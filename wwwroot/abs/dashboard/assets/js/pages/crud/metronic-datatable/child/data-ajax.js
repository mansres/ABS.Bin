...
var StudioDatatableChildRemoteDataDemo = (function () {
  // Private functions
    ...
    var datatable = $(".abs-datatable").StudioDatatable({
      ...
      data: {
        ...
        source: {
          read: {
            url:
              "https://fenix-alliance.com/abss/preview/api/datatables/demos/customers.php",
          },
        },
        ...
        .StudioDatatable({
          data: {
            ...
            source: {
              read: {
                url:
                  "https://fenix-alliance.com/abss/preview/api/datatables/demos/orders.php",
                params: {
                  // custom query params
                  query: {
                    generalSearch: "",
...
jQuery(document).ready(function () {
  StudioDatatableChildRemoteDataDemo.init();
});
