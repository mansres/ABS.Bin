"use strict";
var StudioDatatablesBasicBasic = (function () {
  var initTable1 = function () {
    ...
    table.DataTable({
      ...
      headerCallback: function (thead, data, start, end, display) {
        thead.getElementsByTagName("th")[0].innerHTML = `
                    <label class="abs-checkbox abs-checkbox--single abs-checkbox--solid">
    ...
    table.on("change", "tbody tr .abs-checkbox", function () {
...
jQuery(document).ready(function () {
  StudioDatatablesBasicBasic.init();
});
