"use strict";
var StudioDatatablesSearchOptionsAdvancedSearch = (function () {
            ...
            switch (column.title()) {
              case "Country":
                column
                  ...
                  .sort()
                  .each(function (d, j) {
                    $('.abs-input[data-col-index="2"]').append(
              ...
              case "Status":
                ...
                column
                  ...
                  .sort()
                  .each(function (d, j) {
                    $('.abs-input[data-col-index="6"]').append(
                      '<option value="' +
                        d +
                        '">' +
                        status[d].title +
              ...
              case "Type":
                ...
                column
                  ...
                  .sort()
                  .each(function (d, j) {
                    $('.abs-input[data-col-index="7"]').append(
                      '<option value="' +
                        d +
                        '">' +
                        status[d].title +
...
jQuery(document).ready(function () {
  StudioDatatablesSearchOptionsAdvancedSearch.init();
});
