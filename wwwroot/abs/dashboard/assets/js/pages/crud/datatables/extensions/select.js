"use strict";
var StudioDatatablesExtensionsKeytable = (function () {
  ...
  var initTable2 = function () {
    ...
    var table = $("#kt_table_2").DataTable({
      ...
      select: {
        style: "multi",
        selector: "td:first-child .abs-checkable",
      },
      headerCallback: function (thead, data, start, end, display) {
        thead.getElementsByTagName("th")[0].innerHTML = `
                    <label class="abs-checkbox abs-checkbox--single abs-checkbox--solid abs-checkbox--brand">
                        <input type="checkbox" value="" class="abs-group-checkable">
                        <span></span>
                    </label>`;
      },
      columnDefs: [
        {
          ...
          render: function (data, type, full, meta) {
            return `
                        <label class="abs-checkbox abs-checkbox--single abs-checkbox--solid abs-checkbox--brand">
                            <input type="checkbox" value="" class="abs-checkable">
                            <span></span>
                        </label>`;
          },
        },
    ...
    table.on("change", ".abs-group-checkable", function () {
      var set = $(this).closest("table").find("td:first-child .abs-checkable");
...
jQuery(document).ready(function () {
  StudioDatatablesExtensionsKeytable.init();
});
