 ...
 */
$(function(){"use strict";function l(){t=$(window).width();c=$(window).height();e=$(".menu-button").is(":visible")?!0:!1;$(".fixed-header-margin").css({"padding-top":$("header").outerHeight(!0)});$(".parallax-slide").css({height:c})}function r(){$(".popup.active").animate({opacity:"0"},300,function(){$(this).removeClass("active");$(".cart-box").removeClass("cart-left cart-right")})}function y(){l();$(".navigation:not(.disable-animation)").addClass("disable-animation");$('.swiper-container.initialized[data-slides-per-view="responsive"]').each(function(){var t=i["swiper-"+$(this).attr("id")],n=$(this),r=b(n),e=t.params.centeredSlides,u,f;t.params.slidesPerView=r;t.update();e||(u=n.find(".pagination span"),f=u.hide().slice(0,u.length+1-r),f.length<=1||r>=n.find(".swiper-slide").length?n.addClass("pagination-hidden"):n.removeClass("pagination-hidden"),f.show())})}function p(){f=$(window).scrollTop();var n=$("header").outerHeight()<=200?$("header").outerHeight():200;f>=n&&!$(".header-demo").length?(!$("header").hasClass("fixed-header"),o||r()):$("header").hasClass("fixed-header")&&(o||r());$("nav").addClass("disable-animation")}function w(){$(".swiper-container:not(.initialized)").each(function(){var n=$(this),t="swiper-unique-id-"+a,f,u,c,e,s;n.addClass("swiper-"+t+" initialized").attr("id",t);n.find(".pagination").addClass("pagination-"+t);f=parseInt(n.attr("data-autoplay"),10);o&&(f=0);var h=parseInt(n.attr("data-center"),10),l=n.closest(".circle-description-slide-box").length?!1:!0,r=n.attr("data-slides-per-view");r=r==="responsive"?b(n):parseInt(r,10);u=parseInt(n.attr("data-loop"),10);c=parseInt(n.attr("data-speed"),10);i["swiper-"+t]=new Swiper(".swiper-"+t,{speed:c,pagination:".pagination-"+t,loop:u,paginationClickable:!0,autoplay:f,slidesPerView:r,keyboardControl:!0,calculateHeight:!0,simulateTouch:l,centeredSlides:h,roundLengths:!0,onSlideChangeEnd:function(t){var r=u===!0?t.activeIndex:t.activeLoopIndex,i;(n.closest(".navigation-banner-swiper").length||n.closest(".parallax-slide").length)&&(i=n.find(".swiper-slide-active").attr("data-val"),n.find('.swiper-slide[data-val="'+i+'"]').addClass("active"))},onSlideChangeStart:function(t){var r=u===!0?t.activeIndex:t.activeLoopIndex;n.hasClass("product-preview-swiper")?(i["swiper-"+n.parent().find(".product-thumbnails-swiper").attr("id")].swipeTo(r),n.parent().find(".product-thumbnails-swiper .swiper-slide.selected").removeClass("selected"),n.parent().find(".product-thumbnails-swiper .swiper-slide").eq(r).addClass("selected")):n.find(".swiper-slide.active").removeClass("active")},onSlideClick:function(t){n.hasClass("product-preview-swiper")?(n.find(".default-image").attr("src",n.find(".swiper-slide-active img").attr("src")),n.find(".zoomed-image").attr("src",n.find(".swiper-slide-active img").data("zoom")),n.find(".product-zoom-container").addClass("visible").animate({opacity:"1"})):n.hasClass("product-thumbnails-swiper")&&(i["swiper-"+n.parent().parent().find(".product-preview-swiper").attr("id")].swipeTo(t.clickedSlideIndex),n.find(".active").removeClass("active"),$(t.clickedSlide).addClass("active"))}});i["swiper-"+t].update();h||n.attr("data-slides-per-view")==="responsive"&&(e=n.find(".pagination span"),s=e.hide().slice(0,e.length+1-r),s.length<=1||r>=n.find(".swiper-slide").length?n.addClass("pagination-hidden"):n.removeClass("pagination-hidden"),s.show());a++})}function b(n){return t>=1920&&n.parent().hasClass("full-width-product-slider")?6:t>=it?parseInt(n.attr("data-add-slides"),10):t>=tt?parseInt(n.attr("data-lg-slides"),10):t>=nt?parseInt(n.attr("data-md-slides"),10):t>=g?parseInt(n.attr("data-sm-slides"),10):t>=d?parseInt(n.attr("data-int-slides"),10):parseInt(n.attr("data-xs-slides"),10)}function rt(n,t){var i=t.parent().parent().find(n),r;return u?!1:(u=1,i.last().clone(!0).insertBefore(i.first()),i.last().remove(),r=i.outerWidth(!0),i.parent().css("left","-"+r+"px"),i.parent().animate({left:"0px"},300,function(){u=0}),!1)}function ut(n,t){var i=t.parent().parent().find(n),r;return u?!1:(u=1,i.first().clone(!0).insertAfter(i.last()),r=i.outerWidth(!0),i.parent().animate({left:"-"+r+"px"},300,function(){i.first().remove();i.parent().css("left","0px");u=0}),!1)}function k(t,i){var f=t,e=i.pageX-n.thisOf.left,o=i.pageY-n.thisOf.top,r=e-n.zoomW*.5,u=o-n.zoomH*.5;r<0?r=0:r+n.zoomW>n.thisW&&(r=n.thisW-n.zoomW);u<0?u=0:u+n.zoomH>n.thisH&&(u=n.thisH-n.zoomH);f.find(".move-box").css({left:e*-2,top:o*-2});f.find(".zoom-area").css({left:r,top:u})}function v(n){n.addClass("visible active")}var i=[],t,c,f,e,d=500,g=768,nt=992,tt=1200,it=1600,o=navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i),a,h,s,u,n;l();$(".search-drop-down .overflow").length&&!o&&($(".search-drop-down").addClass("active"),$(".search-drop-down .overflow").jScrollPane(),$(".search-drop-down").removeClass("active"));o&&$("body").addClass("mobile");$(window).load(function(){l();$("#loader-wrapper").fadeOut();$("body").addClass("loaded");w()});o?window.addEventListener("orientationchange",function(){y()},!1):$(window).resize(function(){y()});p();$(window).scroll(function(){p()});a=0;$(".swiper-arrow-left").click(function(){i["swiper-"+$(this).parent().attr("id")].swipePrev()});$(".swiper-arrow-right").click(function(){i["swiper-"+$(this).parent().attr("id")].swipeNext()});$("nav>ul>li").on("mouseover",function(){e||$(this).find(".submenu").stop().fadeIn(300)});$("nav>ul>li").on("mouseleave",function(){e||$(this).find(".submenu").stop().fadeOut(300)});$("nav li .fa").on("click",function(){e&&($(this).next(".submenu").slideToggle(),$(this).parent().toggleClass("opened"))});$(".submenu-list-title .toggle-list-button").on("click",function(){e&&($(this).parent().next(".toggle-list-container").slideToggle(),$(this).parent().toggleClass("opened"))});$(".menu-button").on("click",function(){return $(".navigation.disable-animation").removeClass("disable-animation"),$("body").addClass("opened-menu"),$(this).closest("header").addClass("opened"),$(".opened .close-header-layer").fadeIn(300),r(),!1});$(".close-header-layer, .close-menu").on("click",function(){$(".navigation.disable-animation").removeClass("disable-animation");$("body").removeClass("opened-menu");$("header.opened").removeClass("opened");$(".close-header-layer:visible").fadeOut(300)});$(".toggle-desktop-menu").on("click",function(){$(".navigation").toggleClass("active");$("nav").removeClass("disable-animation");$(".search-drop-down").removeClass("active")});h=0;$(".tab-switcher").on("click",function(){if($(this).hasClass("active")||h)return!1;h=1;var n=$(this).parent().find(".tab-switcher").index(this);$(this).parent().find(".active").removeClass("active");$(this).addClass("active");$(this).closest(".tabs-container").find(".tabs-entry:visible").animate({opacity:"0"},300,function(){$(this).hide();var t=$(this).parent().find(".tabs-entry").eq(n);t.show().css({opacity:"0"});t.find(".swiper-container").length&&(i["swiper-"+t.find(".swiper-container").attr("id")].updateSize(),t.find(".swiper-active-switch").length||t.find(".swiper-pagination-switch:first").addClass("swiper-active-switch"));t.animate({opacity:"1"},function(){h=0})})});$(".swiper-tabs .title, .links-drop-down .title").on("click",function(){$(this).toggleClass("active");$(this).next().slideToggle(300)});$(".sidebar-navigation .title").on("click",function(){$(".sidebar-navigation .title .fa").is(":visible")&&($(this).parent().find(".list").slideToggle(300),$(this).parent().toggleClass("active"))});$(".search-drop-down .title").on("click",function(){$(this).parent().toggleClass("active")});$(".search-drop-down .category-entry").on("click",function(){var n=$(this).closest(".search-drop-down");n.removeClass("active");n.find(".title span").text($(this).text())});$(".open-search-popup").on("click",function(n){return $(".search-box.popup").hasClass("active")?r():(clearTimeout(s),$(".cart-box.active").animate({opacity:"0"},300,function(){$(this).removeClass("active")}),$(".search-box.popup").addClass("active").css({right:t-$(this).offset().left-$(this).outerWidth()*.5-45,top:$(this).offset().top-f+.5*$(this).height()+35,opacity:"0"}).stop().animate({opacity:"1"},300,function(){$(".search-box.popup input").focus()})),n.pageY-f>c-100?$(".search-box.popup").addClass("bottom-align"):$(".search-box.popup").removeClass("bottom-align"),!1});$(".open-cart-popup").on("mouseover",function(){clearTimeout(s);$(".cart-box.popup").hasClass("active")||(r(),$(this).offset().left>t*.5?$(".cart-box.popup").addClass("active cart-right").css({left:"auto",right:t-$(this).offset().left-$(this).outerWidth()*.5-47,top:$(this).offset().top-f+15,opacity:"0"}).stop().animate({opacity:"1"},300):$(".cart-box.popup").addClass("active cart-left").css({right:"auto",left:$(this).offset().left,top:$(this).offset().top-f+15,opacity:"0"}).stop().animate({opacity:"1"},300))});$(".open-cart-popup").on("mouseleave",function(){s=setTimeout(function(){r()},1e3)});s=0;$(".cart-box.popup").on("mouseover",function(){clearTimeout(s)});$(".cart-box.popup").on("mouseleave",function(){s=setTimeout(function(){r()},1e3)});$(".departmets-drop-down .title").on("click",function(){$(this).parent().find(".list").slideToggle(300);$(this).toggleClass("active")});$(".departmets-drop-down").on("mouseleave",function(){$(this).find(".list").slideUp(300);$(this).find(".title").removeClass("active")});u=0;$(".menu-slider-arrows .left").on("click",function(){rt(".menu-slider-entry",$(this))});$(".menu-slider-arrows .right").on("click",function(){ut(".menu-slider-entry",$(this))});n={};$(".product-zoom-container").on("mouseover",function(t){var i=$(this);n.thisW=i.width();n.thisH=i.height();n.zoomW=i.find(".zoom-area").outerWidth();n.zoomH=i.find(".zoom-area").outerHeight();n.thisOf=i.offset();k($(this),t)});$(".product-zoom-container").on("mousemove",function(n){k($(this),n)});$(".product-zoom-container").on("click",function(){$(this).animate({opacity:"0"},function(){$(this).removeClass("visible")})});$(".product-zoom-container").on("mouseleave",function(){$(this).click()});$(".size-selector .entry").on("click",function(){$(this).parent().find(".active").removeClass("active");$(this).addClass("active")});$(".color-selector .entry").on("click",function(){$(this).parent().find(".active").removeClass("active");$(this).addClass("active")});$(".number-plus").on("click",function(){var n=$(this).parent().find(".number"),t=parseInt(n.text(),10)+1;n.text(t)});$(".number-minus").on("click",function(){var n=$(this).parent().find(".number"),t=parseInt(n.text(),10)-1;t>=1&&n.text(t)});$(".accordeon-title").on("click",function(){$(this).toggleClass("active");$(this).next().slideToggle()});$(".open-image").on("click",function(){return v($("#image-popup")),!1});$(".open-product").on("click",function(){return v($("#product-popup")),w(),!1});$(".open-subscribe").on("click",function(){return v($("#subscribe-popup")),$("#subscribe-popup .styled-form .field-wrapper input").focus(),!1});$(".close-popup, .overlay-popup .close-layer").on("click",function(){$(".overlay-popup.visible").removeClass("active");setTimeout(function(){$(".overlay-popup.visible").removeClass("visible")},500)});$(".sort-button").click(function(){$(this).toggleClass("active")});$(".view-button.grid").click(function(){if($(this).hasClass("active"))return!1;$(".shop-grid").fadeOut(function(){$(".shop-grid").removeClass("list-view").addClass("grid-view");$(this).fadeIn()});$(this).parent().find(".active").removeClass("active");$(this).addClass("active")});$(".view-button.list").click(function(){if($(this).hasClass("active"))return!1;$(".shop-grid").fadeOut(function(){$(".shop-grid").removeClass("grid-view").addClass("list-view");$(this).fadeIn()});$(this).parent().find(".active").removeClass("active");$(this).addClass("active")});$(".message-close").on("click",function(){$(this).parent().hide()});$(".portfolio-entry").on("mouseover",function(){$(this).addClass("active")});$(".portfolio-entry").on("mouseleave",function(){$(this).removeClass("active")});$(".simple-search-form input").on("focus",function(){$(this).closest(".simple-search-form").addClass("active")});$(".simple-search-form input").on("blur",function(){$(this).closest(".simple-search-form").removeClass("active")})});